package live.streaming.api.error;

import live.streaming.framework.web.starter.constants.ErrorAppIdEnum;
import live.streaming.framework.web.starter.error.LiveBaseError;
...
public enum ApiErrorEnum implements LiveBaseError {
    ...
    public int getErrorCode() {
        return Integer.parseInt(ErrorAppIdEnum.LIVE_STREAMING_API_ERROR.getCode() + "" + errorCode);
    }
