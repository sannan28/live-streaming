...
import live.streaming.gift.interfaces.constants.SkuOrderInfoEnum;
import live.streaming.gift.interfaces.dto.*;
import live.streaming.gift.interfaces.rpc.ISkuOrderInfoRpc;
...
public class SkuOrderInfoRpcImpl implements ISkuOrderInfoRpc {
    ...
    public SkuPrepareOrderInfoDTO prepareOrder(PrepareOrderReqDTO reqDTO) {
        ...
        ListenableFuture<SendResult<String, String>> sendResultListenableFuture = kafkaTemplate.send(GiftProviderTopicNames.ROLL_BACK_STOCK, JSON.toJSONString(rollBackStockBO));
