...
import live.streaming.bank.interfaces.constants.TradeTypeEnum;
...
import live.streaming.bank.provider.dao.mapper.LiveCurrencyAccountMapper;
...
import live.streaming.framework.redis.starter.key.BankProviderCacheKeyBuilder;
...
public class LiveCurrencyAccountServiceImpl implements ILiveCurrencyAccountService {
    ...
    public AccountTradeRespDTO consumeForSendGift(AccountTradeReqDTO accountTradeReqDTO) {
        ...
        //todo redis lua 脚本去保证这个原子性
        String lockKey = "live-streaming-bank-provider:balance:lock:" + userId;
