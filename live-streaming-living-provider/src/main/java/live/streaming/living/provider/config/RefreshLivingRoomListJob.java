package live.streaming.living.provider.config;

import live.streaming.framework.redis.starter.key.LivingProviderCacheKeyBuilder;
import live.streaming.living.inerfaces.constants.LivingRoomTypeEnum;
