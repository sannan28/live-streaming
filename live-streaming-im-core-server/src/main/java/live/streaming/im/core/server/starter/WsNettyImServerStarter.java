...
import live.streaming.im.core.server.common.WebsocketEncoder;
import live.streaming.im.core.server.handler.ws.WsImServerCoreHandler;
import live.streaming.im.core.server.handler.ws.WsSharkHandler;
...
@Slf4j
@Configuration
public class WsNettyImServerStarter {
