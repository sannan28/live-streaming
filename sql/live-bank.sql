...
-- Create syntax for TABLE 't_live_currency_account'
CREATE TABLE `t_live_currency_account` (
  `user_id` bigint unsigned NOT NULL COMMENT '用户id',
...
-- Create syntax for TABLE 't_live_currency_trade'
CREATE TABLE `t_live_currency_trade` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
